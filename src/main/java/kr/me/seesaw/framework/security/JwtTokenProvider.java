...
public class JwtTokenProvider {
    ...
    public JsonWebToken generateTokenInfo(UserPrincipal userPrincipal) {
        Collection<String> authorities = userPrincipal.getAuthorities()
                ...
                .toList();
        return generateTokenInfo(userPrincipal.getUsername(), userPrincipal.getUser().getId(), authorities);
    }

    public JsonWebToken generateTokenInfo(String username, String userId, Collection<String> authorities) {
        String accessToken = generateAccessToken(username, userId, authorities);
