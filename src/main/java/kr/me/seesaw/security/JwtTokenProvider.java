...
public class JwtTokenProvider {
     ...
     * @return 토큰 정보 객체
     */
    public TokenInfo generateTokenInfo(UserPrincipal userPrincipal) {
        ...
        return new TokenInfo(accessToken, refreshToken, ACCESS_TOKEN_EXPIRATION);
    }
    ...
    public String generateToken(UserPrincipal userPrincipal) {
        ...
        return generateAccessToken(userPrincipal.getUsername(), authorities);
    }
    ...
    public TokenInfo refreshToken(String refreshToken) {
        ...
        try {
            ...
            return new TokenInfo(newAccessToken, newRefreshToken, ACCESS_TOKEN_EXPIRATION);
        } catch (Exception e) {
            throw new IllegalArgumentException("유효하지 않은 리프레시 토큰입니다: " + e.getMessage());
        }
    }
