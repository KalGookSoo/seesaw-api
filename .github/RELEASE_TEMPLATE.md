# 릴리스 노트 템플릿 (Release Note Template) - SEESAW-API
...
## API 변경 내역
<!-- API 변경 사항을 상세히 설명해주세요 -->

### 추가된 API
<!-- 새로 추가된 API 엔드포인트를 나열해주세요 -->
- 

### 수정된 API
<!-- 수정된 API 엔드포인트와 변경 내용을 나열해주세요 -->
- 

### 삭제된 API
<!-- 삭제된 API 엔드포인트를 나열해주세요 -->
- 

### Breaking Changes
<!-- 하위 호환성이 깨지는 변경 사항이 있다면 나열해주세요 -->
- 
